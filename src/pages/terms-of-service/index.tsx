  ...
  return (
    <div className="m-4">
      ...
      <p>
        ...
        even if you have not received a notification of changes as you are bound
        by them even if you have not reviewed them. Your viewing and use of the
        website after such change constitutes your acceptance of the Terms and
        any changes to such terms. If at any time you do not want to be bound by
        the Terms you should logout, exit and cease using the website
        immediately.
      </p>
      <div className="my-4">
        <h2 className="text-3xl font-bold mb-2">Intended Use of Website</h2>
        <p>
      ...
      <div className="my-4">
        <h3 className="text-3xl font-bold mb-2">User Registration</h3>
        <p>
      ...
      <div className="my-4">
        ...
        <p>
          ...
          CARDONE CAPITAL’s investor support through a secure method (which may
          not be through your website account).
        </p>
      </div>
      <div className="my-4">
        <h5 className="text-3xl font-bold mb-2">Content Use Limitations</h5>
        <p>
